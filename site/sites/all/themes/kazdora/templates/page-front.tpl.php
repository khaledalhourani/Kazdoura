  ...
  <div id="page-wrapper"><div id="page">
	...
	<div class="grid_4">
	  <div class="box radius fixheight">
	    <div class="padded">
	      <h2 class="headline radius"><b>البحث</b></h2>
	      <form action="" method="get" name="booking">
	      <!-- calendar image container -->
	      <span style="display: none;"><img src="img/blank.gif" alt="" id="trigger" class="trigger"></span>
		<fieldset class="radius">
		  <p>
		    <label for="destination" class="">مكان ( مدينة، موقع، ...)</label><br>
		    <input type="text" name="destination" value="" class="full" id="destination">
		    </p>
		      <hr class="thin">
		    <p>
		    <label for="sortOrder" class="">ترتيب النتائج</label><br>
		    <select name="sortOrder" id="sortOrder">
		      <option value="GUEST_RATING_ASC" title="Sort by guest rating">التقييم</option>
		      <option value="STAR_RATING_ASC" title="Sort by star rating - low to high">الاحدث</option>
		    </select>
		  </p>
		  <input type="submit" value="بحث »" class="btn btn-custom radius fr">
		</fieldset>
	      </form>
	    </div>
	  </div>
        ...
        <div id="content-area">
          <?php //print $content; ?>
<iframe width="650" height="400" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="http://maps.google.com/?ie=UTF8&amp;ll=28.304381,30.673828&amp;spn=39.355872,79.013672&amp;z=4&amp;output=embed"></iframe><br /><small><a href="http://maps.google.com/?ie=UTF8&amp;ll=28.304381,30.673828&amp;spn=39.355872,79.013672&amp;z=4&amp;source=embed" style="color:#0000FF;text-align:left">View Larger Map</a></small>
        </div>
